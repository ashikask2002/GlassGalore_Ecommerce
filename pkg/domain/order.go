...
// type OrderDetailsWithImage struct{
// 	Orderdetails Order
// }
...
type Order struct {
	gorm.Model
	UserID          uint    `json:"user_id" gorm:"not null"`    //Users           Users         `json:"-" gorm:"foreignkey:UserID"`
	AddressID       uint    `json:"address_id" gorm:"not null"` //Address         Address       `json:"-" gorm:"foreignkey:AddressID"`
